...
public class Constant {
    public static final String LEADER_ESCORT_SCORE = "escort_leader_escort_score";
    ...
    public static final String COMBAT_LOG_PULLING_BACK = "combat_log_pulling_back";
    public static final String COMBAT_LOG_RETURNING_TO_ACTION = "combat_log_returning_to_action";
    public static final String AUTOMATED_ESCORT_MSG = "automated_escort_msg";
